		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ejemplo de Worklist",
									"targetURL": "#EjemplodeWorklist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"EjemplodeWorklist-display": {
								"semanticObject": "EjemplodeWorklist",
								"action": "display",
								"description": "Layout de páginas",
								"title": "Ejemplo de Worklist",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=worklist.template",
									"url": sap.ui.require.toUrl("worklist/template")
								}
							}
						}
					}
