sap.ui.define([
	...
	return Opa5.extend("worklist.template.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["worklist/template/localService/mockserver"], function (mockserver) {
